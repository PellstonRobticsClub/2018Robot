 ...
 *
 */
public class KeepAngleCommmand extends PIDCommand {

	private double angle;
	
    public KeepAngleCommmand(double desiredAngle) {
     super("KeepAngleCommmand", .015, 0, .002, .02);
     
     getPIDController().setInputRange(-180.0, 180.0);
     getPIDController().setContinuous(true);
     getPIDController().setAbsoluteTolerance(.752);
